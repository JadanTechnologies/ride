...
export const PassengerPortal: React.FC<PassengerPortalProps> = ({ user, pricing, surge, history, onRideComplete, onLogout, onNotify }) => {
    ...
    const [bookingStep, setBookingStep] = useState<'input' | 'estimating' | 'confirm' | 'negotiating'>('input');
    ...
    const [driverCounter, setDriverCounter] = useState<number | null>(null);
    const [negotiationStatus, setNegotiationStatus] = useState<'idle' | 'offering' | 'countered' | 'accepted' | 'rejected'>('idle');
    ...
    return (
        <>
            ...
            <div className="relative min-h-[calc(100vh-4rem)]">
                ...
                <div className="absolute bottom-0 md:top-4 md:left-4 md:w-96 p-4 z-[1000] space-y-4">
                    {
                        viewState === 'booking' && (
